...
const Notifications = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <nav className="flex justify-between items-center bg-red-400 text-white px-6 py-4 shadow-md">
        <h2 className="text-xl font-semibold">Notifications</h2>
        <div className="flex items-center space-x-4">
          <Link to="/user">
            <button className="bg-red-500 text-white py-2 px-4 text-2xl rounded-md hover:bg-red-600 transition duration-200 shadow">
              <FaHome />
            </button>
          </Link>
          <Link to="/calendar">
