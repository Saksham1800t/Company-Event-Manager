...
const AdminForm = () => {
  ...
  return (
    <>
      <div className="flex justify-center items-center min-h-screen bg-gradient-to-l from-red-400 to-pink-600">
        <div className="bg-red-100 shadow-lg rounded-lg p-6 w-11/12 md:w-2/3 lg:w-1/2 m-8">
